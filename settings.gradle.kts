...
project(":core:download").projectDir = file("core_download")
include(":core:storage")
project(":core:storage").projectDir = file("core_storage")
...
include(":feature:rubrics")
project(":feature:rubrics").projectDir = file("feature_rubrics")
include(":feature:profile")
project(":feature:profile").projectDir = file("feature_profile")